...
int 	print_pbm(char *fn,int a,int b,int c,int d,int l,int t,int r,int st,int sh);
int 	print_ppm(char *fn,int a,int b,int c,int d,int l,int t,int r,int st,int sh);
